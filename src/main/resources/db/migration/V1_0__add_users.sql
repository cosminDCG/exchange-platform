...
create table if not exists product (id binary not null, address varchar(255), available boolean, description varchar(255), name varchar(255), price double, type varchar(255), seller_id binary, primary key (id));
